...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '*╔══════════════*\n*╟❧ @subject*\n*╠══════════════*\n*╟❧ @user*\n*╟❧ /𝙰* \n*║*\n*╟❧ 𝙳𝙴𝚂𝙲𝚁𝙸𝙿𝚃𝙸𝙾𝙽  𝙶𝚁𝙾𝚄𝙿:*\n\n@desc\n\n*║*\n*╟❧ 𝙱𝚈 𝙼𝙸𝚉𝚃𝚈!!*\n*╚══════════════*';
  conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ BYE BYE 👋🏻* \n*╚══════════════*';
  conn.spromote = '*@user 𝙿𝚁𝙾𝙼𝙾𝚃𝙴 𝙱𝚈 𝙰𝙳𝙼𝙸𝙽𝚂!!*';
  conn.sdemote = '*@user 𝙳𝙴𝙼𝙾𝚃𝙴 𝙰𝙳𝙼𝙸𝙽𝚂 !!*';
  conn.sDesc = '*𝙲𝙷𝙰𝙽𝙶𝙴𝙳 𝙶𝚁𝙾𝚄𝙿 𝙳𝙴𝚂𝙲𝚁𝙸𝙿𝚃𝙸𝙾𝙽*\n\n*𝙽𝙴𝚆 𝙳𝙴𝚂𝙲𝚁𝙸𝙿𝚃𝙸𝙾𝙽:* @desc';
  conn.sSubject = '*𝙼𝙾𝙳𝙸𝙵𝙸𝙴𝙳 𝙶𝚁𝙾𝚄𝙿 𝙽𝙰𝙼𝙴*\n*𝙽𝙴𝚆 𝚂𝚄𝙱𝙹𝙴𝙲𝚃:* @subject';
  conn.sIcon = '*𝙲𝙷𝙰𝙽𝙶𝙴𝙳 𝙶𝚁𝙾𝚄𝙿 𝙸𝙲𝙾𝙽!!*';
  conn.sRevoke = '* @revoke';
...
setInterval(async () => {
  ...
  const bio = `🤖 ᴜᴘ ᴛɪᴍᴇ: ${uptime} ┃ 👑 ʙʏ ᴍɪᴢᴛᴀ ┃ 🔗 ᴏғᴄ: `;
...
function clockString(ms) {
  ...
  return [d, ' 𝙳ay(s) ️', h, ' Hours(s) ', m, ' Minute(s) ', s, ' Sec(s) '].map((v) => v.toString().padStart(2, 0)).join('');
}
